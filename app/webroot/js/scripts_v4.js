(function($){
	$(document).ready(function(e) {
    	...
    	if ($('#modal-critical_disclaimer').length > 0) {
        	$('#modal-critical_disclaimer').modal();
    	}
		...
		*/
		...
		window.selec_tariff = function() {
			...
			if ($('#elec_recent_bill').val() == 'No') {
				...
				$('#elec_meter_type_fields').show();
				if (pricing_groups == 'Single Rate' || pricing_groups == 'Demand Single Rate') {
					$('#elec_meter_type_fields .radio').hide();
					$('#singlerate_radio').show();
					$('#singlerate_radio input:radio').trigger( 'click' );
				}
				else if (pricing_groups == 'Single Rate + CL1' || pricing_groups == 'Demand Single Rate + CL1') {
					$('#elec_meter_type_fields .radio').hide();
					$('#singlerate_cl1_radio').show();
					$('#singlerate_cl1_radio input:radio').trigger( 'click' );
				}
				else if (pricing_groups == 'Single Rate + CL2' || pricing_groups == 'Demand Single Rate + CL2') {
					$('#elec_meter_type_fields .radio').hide();
					$('#singlerate_cl2_radio').show();
					$('#singlerate_cl2_radio input:radio').trigger( 'click' );
				}
				else if (pricing_groups == 'Single Rate + CL1 + CL2' || pricing_groups == 'Demand Single Rate + CL1 + CL2') {
					$('#elec_meter_type_fields .radio').hide();
					$('#singlerate_cl1_cl2_radio').show();
				...
				else if (pricing_groups == 'Time of Use' || pricing_groups == 'Transitional Time of Use' || pricing_groups == 'Demand Time of Use' || pricing_groups == 'Demand Seasonal Time of Use') {
					$('#elec_meter_type_fields .radio').hide();
					$('#timeofuse_radio').show();
				...
				else if (pricing_groups == 'Time of Use + CL1' || pricing_groups == 'Transitional Time of Use + CL1' || pricing_groups == 'Demand Time of Use + CL1' || pricing_groups == 'Demand Seasonal Time of Use + CL1') {
					$('#elec_meter_type_fields .radio').hide();
				...
				else if (pricing_groups == 'Time of Use + CL2' || pricing_groups == 'Transitional Time of Use + CL2' || pricing_groups == 'Demand Time of Use + CL2' || pricing_groups == 'Demand Seasonal Time of Use + CL2') {
					$('#elec_meter_type_fields .radio').hide();
				...
				else if (pricing_groups == 'Time of Use + CL1 + CL2' || pricing_groups == 'Demand Time of Use + CL1 + CL2' || pricing_groups == 'Demand Seasonal Time of Use + CL1 + CL2') {
					$('#elec_meter_type_fields .radio').hide();
					$('#timeofuse_cl1_cl2_radio').show();
					$('#timeofuse_cl1_cl2_radio input:radio').trigger( 'click' );
					if (pricing_groups == 'Demand Time of Use + CL1 + CL2') {
						$('#timeofuse_cl1_cl2_radio input:radio').val('Demand Time of Use + CL1 + CL2');
						$('#timeofuse_cl1_cl2_radio span.elec_meter_type_label').text('Demand Time of Use');
					} else if (pricing_groups == 'Demand Seasonal Time of Use + CL1 + CL2') {
						$('#timeofuse_cl1_cl2_radio input:radio').val('Demand Seasonal Time of Use + CL1 + CL2');
						$('#timeofuse_cl1_cl2_radio span.elec_meter_type_label').text('Demand Seasonal Time of Use');
					} else {
						$('#timeofuse_cl1_cl2_radio input:radio').val('Time of Use + CL1 + CL2');
						$('#timeofuse_cl1_cl2_radio span.elec_meter_type_label').text('Time of Use');
					}
				}
        ...
        $(document).on('click', '.customer-type', function() {
			...
			$.post("/tools/get_usage_level", {plan_type: 'Elec', customer_type: id, version: 4}, function(response) {
            ...
            $.post("/tools/get_usage_level", {plan_type: 'Gas', customer_type: id, version: 4}, function(response) {
        ...
        if ($('#customer_type').val()) {
	        var customer_type = $('#customer_type').val();
	        $.post("/tools/get_usage_level", {plan_type: 'Elec', customer_type: customer_type, version: 4}, function(response) {
                $('#elec_usage_level_buttons').html(response.html);
                if ($('#elec_usage_level').val()) {
                    var elec_usage_level = $('#elec_usage_level').val();
                    $('.elec-usages #' + elec_usage_level).trigger( 'click' );
            ...
            $.post("/tools/get_usage_level", {plan_type: 'Gas', customer_type: customer_type, version: 4}, function(response) {
                $('#gas_usage_level_buttons').html(response.html);
                if ($('#gas_usage_level').val()) {
    	            var gas_usage_level = $('#gas_usage_level').val();
                    $('.gas-usages #' + gas_usage_level).trigger( 'click' );
		...
		$(document).on('click', '.plan-type,.elec-recent-bill-choices .choice,.gas-recent-bill-choices .choice', function() {
			...
			if ($('#state').val() && $('#customer_type').val() && ($('#elec_usage_level').val() || $('#gas_usage_level').val())) {
    			$.post("/v5/get_default_consumption", {state: $('#state').val(), customer_type: $('#customer_type').val(), elec_usage_level: $('#elec_usage_level').val(), gas_usage_level: $('#gas_usage_level').val()}, function(response) {
        			switch(plan_type) {
            			case 'Dual':
                            if ($('#elec_recent_bill').val() == 'No' && $('#gas_recent_bill').val() == 'No') {
                                $('.elec-and-gas-elec-peak').text(response.elec.peak);
                                $('.elec-and-gas-elec-billing-days').text(response.elec.billing_days);
                                $('.elec-and-gas-gas-peak').text(response.gas.peak);
                                $('.elec-and-gas-gas-billing-days').text(response.gas.billing_days);
                                $('.elec-and-gas').show();
                                $('.no-bill-script').show();
                            } else if ($('#elec_recent_bill').val() == 'No' && $('#elec_usage_level').val()) {
                                var peak = response.elec.peak;
                                var billing_days = response.elec.billing_days;
                                $('.elec-peak-usage').text(peak);
                                $('.elec-billing-days').text(billing_days);
                                $('.elec-only').show();
                                $('.no-bill-script').show();
                            } else if ($('#gas_recent_bill').val() == 'No' && $('#gas_usage_level').val()) {
                                var peak = response.gas.peak;
                                var billing_days = response.gas.billing_days;
                                $('.gas-peak-usage').text(peak);
                                $('.gas-billing-days').text(billing_days);
                                $('.gas-only').show();
                                $('.no-bill-script').show();
                            }
            			    break;
            			 case 'Elec':
            			    if ($('#elec_recent_bill').val() == 'No' && $('#elec_usage_level').val()) {
                                var peak = response.elec.peak;
                                var billing_days = response.elec.billing_days;
                                $('.elec-peak-usage').text(peak);
                                $('.elec-billing-days').text(billing_days);
            			    ...
            			    break;
            			 case 'Gas':
            			    if ($('#elec_recent_bill').val() == 'No' && $('#gas_usage_level').val()) {
                                var peak = response.gas.peak;
                                var billing_days = response.gas.billing_days;
                                $('.gas-peak-usage').text(peak);
                                $('.gas-billing-days').text(billing_days);
		...
		$(document).on('click', '.elec-usages .usage', function() {
            ...
            $.post("/v4/get_default_consumption", {state: $('#state').val(), customer_type: $('#customer_type').val(), elec_usage_level: $('#elec_usage_level').val(), gas_usage_level: $('#gas_usage_level').val()}, function(response) {
                if ($('#plan_type').val() == 'Dual' && $('#gas_recent_bill').val() == 'No' && $('#gas_usage_level').val()) {
                    $('.elec-and-gas-elec-peak').text(response.elec.peak);
                    $('.elec-and-gas-elec-billing-days').text(response.elec.billing_days);
                    $('.elec-and-gas-gas-peak').text(response.gas.peak);
                    $('.elec-and-gas-gas-billing-days').text(response.gas.billing_days);
        ...
        $(document).on('click', '.gas-usages .usage', function() {
            ...
            $.post("/v4/get_default_consumption", {state: $('#state').val(), customer_type: $('#customer_type').val(), elec_usage_level: $('#elec_usage_level').val(), gas_usage_level: $('#gas_usage_level').val()}, function(response) {
                if ($('#plan_type').val() == 'Dual' && $('#elec_recent_bill').val() == 'No' && $('#elec_usage_level').val()) {
                    $('.elec-and-gas-elec-peak').text(response.elec.peak);
                    $('.elec-and-gas-elec-billing-days').text(response.elec.billing_days);
                    $('.elec-and-gas-gas-peak').text(response.gas.peak);
                    $('.elec-and-gas-gas-billing-days').text(response.gas.billing_days);
        ...
        $('.radio-hidden').hide();
		$('input[name="elec_meter_type"]').click(function() {
			$('.radio-hidden').hide();
		...
		$('#step1_solar_rebate_scheme_form .continue').click(function(event) {
			$('#solar_rebate_scheme').val('SFiT');
			$("#solar_rebate_scheme_modal").modal('hide');
			event.preventDefault();
		});
		$('#step1_solar_rebate_scheme_form2 .continue').click(function(event) {
			$("#solar_rebate_scheme_modal2").modal('hide');
			event.preventDefault();
		});

		$('#tenant_owner').change(function() {
			var tenant_owner = $(this).val();
			var customer_type = $("#customer_type").val();
			var plan_type = $("#plan_type").val();
			$(".battery-storage-solution").hide();
			$(".battery-storage-solar-solution").hide();
		...
		$(document).on('click', '#step1 .continue', function(event) {
			...
			*/
			...
			var tenant_owner = $('#tenant_owner').val();
			if (!tenant_owner) {
			    $("#tenant_owner").after('<div class="webform_error"><div class="webform_error_left"><div class="webform_error_right"><div class="webform_error_center">Are you the Tenant or the Owner?</div></div></div><div class="webform_error_bottom"></div></div>');
			    e = e || true;
			}
			...
			*/
			...
			if (!e) {
				...
				$('#processing').show();
				$.post("/v4/compare_save/1",$('#step1_form').serialize(),function(response) {
					window.location = "/v4/compare/2";
				});
			}
			else {
		...
		$(document).on('click', '#customer_details .comparison', function(event) {
			...
			*/
			...
			if (!e) {
				$('#processing').show();
				$.post("/v4/customer_details_save",$('#customer_details_form').serialize(),function(response) {
    				$('#processing').hide();
    				$('#sid').val(response);
				    window.location = "/v4/compare/1";
                });
        ...
        $(document).on('click', '#step1 .no-sale-ok', function(event) {
			...
			*/
			...
			if (!e) {
				$('#processing').show();
                $.post("/v4/customer_details_update",$('#step1_form').serialize(),function(response) {
				    window.location.replace("/v4/");
                });
			}
			else {
        ...
        $(document).on('click', '#step3 .no-sale-button', function(event) {
			...
			if (!e) {
				$('#processing').show();
				var url = "/v4/customer_details_update";
				if (sid) {
        ...
        $(document).on('click', '#customer_details .outbound', function(event) {
			...
			if (!e) {
				$('#processing').show();
                $.post('/v4/contact_code_save',{outbound: 1, inbound: 0, contact_code: $('#contact_code').val()},function(response) {
				    window.location = "/v4/compare/1";
                });
            }
            else {
        ...
        $(document).on('click', '#customer_details .inbound', function(event) {
            $('#processing').show();
            $.post('/v4/contact_code_save',{outbound: 0, inbound: 1, contact_code: ''},function(response) {
                $('#processing').hide();
				$('#customer_details_field').show();
            });
            event.preventDefault();
        });
        $('.test-lead').click(function(event) {
            $('#sid').val(1433795);
            lead_lookup();
            event.preventDefault();
        });
		...
		$(document).on('click', '#step2 .continue', function(event) {
			...
			$.post("/v4/compare_save/2",$('#step2_form').serialize(),function(response) {
				window.location = "/v4/compare/3";
            });
            event.preventDefault();
		});
		$(document).on('change', '#step2 .sort_by_select select', function(event) {
			$('#sort_by').val($(this).prop('id'));
			$('#processing').show();
			var sort_by = $(this).attr('id');
			$.post("/v4/compare_save/2",$('#step2_form').serialize(),function(response) {
		...
		$(document).on('click', '.view-details', function(event) {
			...
			if (plan.width() == 724) {
				...
				plan.css('width','724px').siblings().css('display','none').end().find('.plan-info').show('fast');
		...
		$(document).on('click', '#step3_electricity_form .continue', function(event) {
			...
			if (!e) {
				...
				$('#processing').show();
				$.post("/v4/compare_save/3",$('#step3_electricity_form').serialize(),function(response) {
					compare();
				});
			}
            event.preventDefault();
		...
		$(document).on('click', '#step3_gas_form .continue', function(event) {
			...
			if (!e) {
				...
				$('#processing').show();
				$.post("/v4/compare_save/3",$('#step3_gas_form').serialize(),function(response) {
					compare();
				});
			}
            event.preventDefault();
		...
		$(document).on('click', 'form[name="rates_form2"] input[name="discount_guaranteed"], form[name="rates_form2"] input[name="include_gst"]', function(event) {
			...
			$.post("/v4/get_rates/1",$('#rates_form2_' + plan_id).serialize(),function(response) {
		...
		$(document).on('click', '.btn-gst', function(event) {
			...
			$.post("/v4/get_rates",$('#rates_form1_' + plan_id).serialize(),function(response) {
		...
		$(document).on('click', '.btn-gst2', function(event) {
			...
			$(this).parent().tooltip("option", "content", title);
			$.post("/v5/get_rates",$('#rates_form1_' + plan_id).serialize(),function(response) {
				$('#table1_rate_' + plan_id).html(response.html);
			}, "json");
			return false;
			*/
        ...
        window.signup = function(plan_id, elec_rate_id, gas_rate_id, ranking) {
	        $('#processing').show();
			$.post("/v4/signup",{plan_id:plan_id, elec_rate_id:elec_rate_id, gas_rate_id:gas_rate_id, ranking:ranking},function(response) {
				if (response) {
    				$('#processing').hide();
					window.location = "http://signup.compareconnectsave.com.au/admin/customers/signup/" + response.id;
				}
			});
            return false;
        }
        $(document).on("click", '.pause-save', function(event) {
	        $('#processing').show();
			$.post("/v4/pause",{},function(response) {
				if (response) {
    				$('#processing').hide();
					//window.location.replace("/v4/");
				}
        ...
        lead_lookup = function() {
            $.post('/tools/get_lead_fields', {app_key: '48347de54501ba15d16d84dbcbe348fd', lead_id: $('#sid').val()}, function(data) {
        	    ...
        	    var overwrite = true;
                if ((data.sale_completion_date && data.sale_completion_date != '')) {
        	    ...
        	    if (import_data) {
                    ...
                    if (data.customer_type) {
                        $.post("/tools/get_usage_level", {plan_type: 'Elec', customer_type: data.customer_type, version: 4}, function(response) {
                            $('#elec_usage_level_buttons').html(response.html);
                            if ($('#elec_usage_level').val()) {
                                var elec_usage_level = $('#elec_usage_level').val();
                                $('.elec-usages #' + elec_usage_level).trigger( 'click' );
                        ...
                        $.post("/tools/get_usage_level", {plan_type: 'Gas', customer_type: data.customer_type, version: 4}, function(response) {
                            $('#gas_usage_level_buttons').html(response.html);
                            if ($('#gas_usage_level').val()) {
                                var gas_usage_level = $('#gas_usage_level').val();
                                $('.gas-usages #' + gas_usage_level).trigger( 'click' );
                    ...
                    if (data.looking_for) {
                        var id = 'Transfer';
                        if (data.looking_for == 'Move In') {
                            id = 'MoveIn';
	                    }
                        $('#' + id).trigger( 'click' );
                    }
                    if (data.tenant_owner) {
                        if ($("#tenant_owner").length > 0) {
                            $('#tenant_owner').val(data.tenant_owner);
                        }
                    }
		...
		$('#ToolsLeadForm1 #tenant_owner').change(function() {
