...
class V12Controller extends AppController
{
				...
				*/
                ...
                if (!empty($plans_temp)) {
                    ...
                    foreach ($plans_temp as $key => $plan) {
                        ...
                        if ($step1['campaign_name'] == 'Offshore') {
                                ...
                                if ($exception_field) {
                                    $offshore_lead_exceptions = $this->OffshoreLeadExceptions->find('first', array(
                                        'conditions' => array(
                                            ...
                                            "OffshoreLeadExceptions.centre_name" => $step1['lead_origin'],
                                        )
                                    ));
                        ...
                        } elseif ($step1['campaign_name'] == 'SeekLeads') {
    ...
    public function customer_details_update()
    {
        if ($this->request->is('put') || $this->request->is('post')) {
            ...
            $submission_new['submitted']['last_comparison_link'] = 'https://tools.electricitywizard.com.au/v12/compare/1?customer=' . $customer_key;
            $submission_new['submitted']['CompareStep1'] = 'https://tools.electricitywizard.com.au/v12/compare/1?customer=' . $customer_key;
            $submission_new['submitted']['CompareStep2'] = 'https://tools.electricitywizard.com.au/v12/compare/2?customer=' . $customer_key;
            $submission_new['submitted']['CompareStep3'] = 'https://tools.electricitywizard.com.au/v12/compare/3?customer=' . $customer_key;
    ...
    public function get_rates($details = false)
    {
        ...
        if ($this->request->is('put') || $this->request->is('post')) {
            ...
            if ($details) {
                $view_output = $view->render('/Elements/rate_details_v12');
            } else {
                $view_output = $view->render('/Elements/rates_v12');
            }
            return new CakeResponse(array(
                'body' => json_encode(array(
                    'html' => $view_output
    ...
    public function signup()
    {
        if ($this->request->is('put') || $this->request->is('post')) {
            ...
            if ($sid) {
                $submission = array();
                $submission['submitted']['last_comparison_link'] = 'https://tools.electricitywizard.com.au/v12/compare/1?customer=' . $customer_key;
                $submission['submitted']['CompareStep1'] = 'https://tools.electricitywizard.com.au/v12/compare/1?customer=' . $customer_key;
                $submission['submitted']['CompareStep2'] = 'https://tools.electricitywizard.com.au/v12/compare/2?customer=' . $customer_key;
                $submission['submitted']['CompareStep3'] = 'https://tools.electricitywizard.com.au/v12/compare/3?customer=' . $customer_key;
                $this->update_lead($campaign_id, $sid, $submission);
            }
    ...
    private function add_lead_action($lead_id, $action_id)
    {
        ...
        $action_note = urlencode('Tools V12 - Update');
        $ch = curl_init();
    ...
    private function assign_to_agent($lead_id, $agent_id)
    {
        ...
        $this->LeadAgent->save(array('LeadAgent' => array(
            ...
            'response' => $response,
            'submitted' => date('Y-m-d H:i:s'),
            'source' => 'Tools V12 - assign to agent',
        )));
