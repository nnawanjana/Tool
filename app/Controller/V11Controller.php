...
class V11Controller extends AppController
{
    ...
    public function customer_details_update()
    {
        if ($this->request->is('put') || $this->request->is('post')) {
            ...
            $submission_new['submitted']['last_comparison_link'] = 'https://tools.electricitywizard.com.au/v11/compare/1?customer=' . $customer_key;
            $submission_new['submitted']['CompareStep1'] = 'https://tools.electricitywizard.com.au/v11/compare/1?customer=' . $customer_key;
            $submission_new['submitted']['CompareStep2'] = 'https://tools.electricitywizard.com.au/v11/compare/2?customer=' . $customer_key;
            $submission_new['submitted']['CompareStep3'] = 'https://tools.electricitywizard.com.au/v11/compare/3?customer=' . $customer_key;
    ...
    public function get_rates($details = false)
    {
        ...
        if ($this->request->is('put') || $this->request->is('post')) {
            ...
            if ($details) {
                $view_output = $view->render('/Elements/rate_details_v11');
            } else {
                $view_output = $view->render('/Elements/rates_v11');
            }
            return new CakeResponse(array(
                'body' => json_encode(array(
                    'html' => $view_output
    ...
    public function signup()
    {
        if ($this->request->is('put') || $this->request->is('post')) {
            ...
            if ($sid) {
                $submission = array();
                $submission['submitted']['last_comparison_link'] = 'https://tools.electricitywizard.com.au/v11/compare/1?customer=' . $customer_key;
                $submission['submitted']['CompareStep1'] = 'https://tools.electricitywizard.com.au/v11/compare/1?customer=' . $customer_key;
                $submission['submitted']['CompareStep2'] = 'https://tools.electricitywizard.com.au/v11/compare/2?customer=' . $customer_key;
                $submission['submitted']['CompareStep3'] = 'https://tools.electricitywizard.com.au/v11/compare/3?customer=' . $customer_key;
                $this->update_lead($campaign_id, $sid, $submission);
            }
    ...
    private function add_lead_action($lead_id, $action_id)
    {
        ...
        $action_note = urlencode('Tools V11 - Update');
        $ch = curl_init();
    ...
    private function assign_to_agent($lead_id, $agent_id)
    {
        ...
        $this->LeadAgent->save(array('LeadAgent' => array(
            ...
            'response' => $response,
            'submitted' => date('Y-m-d H:i:s'),
            'source' => 'Tools V11 - assign to agent',
        )));
