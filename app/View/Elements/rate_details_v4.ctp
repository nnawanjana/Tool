...
<?php if ($rate_type == 'Elec' || $rate_type == 'Dual'):?>
    ...
    <?php else:?>
        ...
        $umo = $plan['Plan']['unit_of_measurement_of_rates'] ? $plan['Plan']['elec_rate']['demand_uom'] : 'kWh';
        $demandFrequency = $plan['Plan']['elec_rate']['demand_frequency'];
        ...
        <?php if ($summer_winnter_rates):?>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td><?php echo ($plan['Plan']['retailer'] != 'Powershop') ? round($plan['Plan']['elec_rate']['stp'] / $stp_ratio * 100 * $gst, 3) : round($plan['Plan']['elec_rate']['stp'] / $stp_ratio * 100 * $gst * (1 - $plan['Plan']['discount_guaranteed_elec'] / 100), 3);?>c/day</td>
                    <?php
                ...
                <?php if (count($tier_rates) == 1):?>
                    <tr>
                        ...
                        <td><?php echo ($plan['Plan']['retailer'] != 'Powershop') ? round($tier_rates[0]['rate'][0] * 100 * $gst, 3) : round($tier_rates[0]['rate'][0] * 100 * $gst * (1 - $plan['Plan']['discount_guaranteed_elec'] / 100), 3);?>c/per kWh</td>
                        <td><?php echo round($tier_rates[0]['rate'][0] * 100 * $gst * (1 - $total_discount_elec / 100), 3);?>c/per kWh</td>
                    </tr>
                <?php endif;?>
                <?php if (count($tier_rates) == 2):?>
                    <tr>
                        <td>First <?php echo round($tier_rates[0]['tier']);?> per kWh/<?php echo $period;?></td>
                        <td><?php echo ($plan['Plan']['retailer'] != 'Powershop') ? round($tier_rates[0]['rate'][0] * 100 * $gst, 3) : round($tier_rates[0]['rate'][0] * 100 * $gst * (1 - $plan['Plan']['discount_guaranteed_elec'] / 100), 3);?>c/per kWh</td>
                        <td><?php echo round($tier_rates[0]['rate'][0] * 100 * $gst * (1 - $total_discount_elec / 100), 3);?>c/per kWh</td>
                    </tr>
                    <tr>
                        <td>Remainder per kWh/<?php echo $period;?></td>
                        <td><?php echo ($plan['Plan']['retailer'] != 'Powershop') ? round($tier_rates[1]['rate'][0] * 100 * $gst, 3) : round($tier_rates[1]['rate'][0] * 100 * $gst * (1 - $plan['Plan']['discount_guaranteed_elec'] / 100), 3);?>c/per kWh</td>
                        <td><?php echo round($tier_rates[1]['rate'][0] * 100 * $gst * (1 - $total_discount_elec / 100), 3);?>c/per kWh</td>
                    </tr>
                <?php endif;?>
                <?php if (count($tier_rates) == 3):?>
                    ...
                    <tr>
                        <td>Next <?php echo round($tier_rates[1]['tier']);?> per kWh/<?php echo $period;?></td>
                        <td><?php echo ($plan['Plan']['retailer'] != 'Powershop') ? round($tier_rates[1]['rate'][0] * 100 * $gst, 3) : round($tier_rates[1]['rate'][0] * 100 * $gst * (1 - $plan['Plan']['discount_guaranteed_elec'] / 100), 3);?>c/per kWh</td>
                        <td><?php echo round($tier_rates[1]['rate'][0] * 100 * $gst * (1 - $total_discount_elec / 100), 3);?>c/per kWh</td>
                    </tr>
                    <tr>
                        <td>Remainder per kWh/<?php echo $period;?></td>
                        <td><?php echo ($plan['Plan']['retailer'] != 'Powershop') ? round($tier_rates[2]['rate'][0] * 100 * $gst, 3) : round($tier_rates[2]['rate'][0] * 100 * $gst * (1 - $plan['Plan']['discount_guaranteed_elec'] / 100), 3);?>c/per kWh</td>
                        <td><?php echo round($tier_rates[2]['rate'][0] * 100 * $gst * (1 - $total_discount_elec / 100), 3);?>c/per kWh</td>
                    </tr>
                <?php endif;?>
                <?php if (count($tier_rates) == 4):?>
                    ...
                    <tr>
                        <td>Next <?php echo round($tier_rates[2]['tier']);?> per kWh/<?php echo $period;?></td>
                        <td><?php echo ($plan['Plan']['retailer'] != 'Powershop') ? round($tier_rates[2]['rate'][0] * 100 * $gst, 3) : round($tier_rates[2]['rate'][0] * 100 * $gst * (1 - $plan['Plan']['discount_guaranteed_elec'] / 100), 3);?>c/per kWh</td>
                        <td><?php echo round($tier_rates[2]['rate'][0] * 100 * $gst * (1 - $total_discount_elec / 100), 3);?>c/per kWh</td>
                    </tr>
                    <tr>
                        <td>Remainder per kWh/<?php echo $period;?></td>
                        <td><?php echo ($plan['Plan']['retailer'] != 'Powershop') ? round($tier_rates[3]['rate'][0] * 100 * $gst, 3) : round($tier_rates[3]['rate'][0] * 100 * $gst * (1 - $plan['Plan']['discount_guaranteed_elec'] / 100), 3);?>c/per kWh</td>
                        <td><?php echo round($tier_rates[3]['rate'][0] * 100 * $gst * (1 - $total_discount_elec / 100), 3);?>c/per kWh</td>
                    </tr>
                <?php endif;?>
                <?php if (count($tier_rates) == 5):?>
                    ...
                    <tr>
                        <td>Next <?php echo round($tier_rates[3]['tier']);?> per kWh/<?php echo $period;?></td>
                        <td><?php echo ($plan['Plan']['retailer'] != 'Powershop') ? round($tier_rates[3]['rate'][0] * 100 * $gst, 3) : round($tier_rates[3]['rate'][0] * 100 * $gst * (1 - $plan['Plan']['discount_guaranteed_elec'] / 100), 3);?>c/per kWh</td>
                        <td><?php echo round($tier_rates[3]['rate'][0] * 100 * $gst * (1 - $total_discount_elec / 100), 3);?>c/per kWh</td>
                    </tr>
                    <tr>
                        <td>Remainder per kWh/<?php echo $period;?></td>
                        <td><?php echo ($plan['Plan']['retailer'] != 'Powershop') ? round($tier_rates[4]['rate'][0] * 100 * $gst, 3) : round($tier_rates[4]['rate'][0] * 100 * $gst * (1 - $plan['Plan']['discount_guaranteed_elec'] / 100), 3);?>c/per kWh</td>
                        <td><?php echo round($tier_rates[4]['rate'][0] * 100 * $gst * (1 - $total_discount_elec / 100), 3);?>c/per kWh</td>
                    </tr>
                <?php endif;?>
            </table>
            ...
            <table>
                ...
                <?php if (count($tier_rates) == 1):?>
                    <tr>
                        <td>Charge per kWh/<?php echo $period;?></td>
                        <td><?php echo ($plan['Plan']['retailer'] != 'Powershop') ? round($tier_rates[0]['rate'][1] * 100 * $gst, 3) : round($tier_rates[0]['rate'][1] * 100 * $gst * (1 - $plan['Plan']['discount_guaranteed_elec'] / 100), 3);?>c/per kWh</td>
                        <td><?php echo round($tier_rates[0]['rate'][1] * 100 * $gst * (1 - $total_discount_elec / 100), 3);?>c/per kWh</td>
                    </tr>
                <?php endif;?>
                <?php if (count($tier_rates) == 2):?>
                    <tr>
                    ...
                    <tr>
                        <td>Remainder per kWh/<?php echo $period;?></td>
                        <td><?php echo ($plan['Plan']['retailer'] != 'Powershop') ? round($tier_rates[1]['rate'][1] * 100 * $gst, 3) : round($tier_rates[1]['rate'][1] * 100 * $gst * (1 - $plan['Plan']['discount_guaranteed_elec'] / 100), 3);?>c/per kWh</td>
                        <td><?php echo round($tier_rates[1]['rate'][1] * 100 * $gst * (1 - $total_discount_elec / 100), 3);?>c/per kWh</td>
                    </tr>
                <?php endif;?>
                <?php if (count($tier_rates) == 3):?>
                    <tr>
                    ...
                    <tr>
                        <td>Remainder per kWh/<?php echo $period;?></td>
                        <td><?php echo ($plan['Plan']['retailer'] != 'Powershop') ? round($tier_rates[2]['rate'][1] * 100 * $gst, 3) : round($tier_rates[2]['rate'][1] * 100 * $gst * (1 - $plan['Plan']['discount_guaranteed_elec'] / 100), 3);?>c/per kWh</td>
                        <td><?php echo round($tier_rates[2]['rate'][1] * 100 * $gst * (1 - $total_discount_elec / 100), 3);?>c/per kWh</td>
                    </tr>
                <?php endif;?>
                <?php if (count($tier_rates) == 4):?>
                    <tr>
                    ...
                    <tr>
                        <td>Remainder per kWh/<?php echo $period;?></td>
                        <td><?php echo ($plan['Plan']['retailer'] != 'Powershop') ? round($tier_rates[3]['rate'][1] * 100 * $gst, 3) : round($tier_rates[3]['rate'][1] * 100 * $gst * (1 - $plan['Plan']['discount_guaranteed_elec'] / 100), 3);?>c/per kWh</td>
                        <td><?php echo round($tier_rates[3]['rate'][1] * 100 * $gst * (1 - $total_discount_elec / 100), 3);?>c/per kWh</td>
                    </tr>
                <?php endif;?>
                <?php if (count($tier_rates) == 5):?>
                    <tr>
                    ...
                    <tr>
                        <td>Remainder per kWh/<?php echo $period;?></td>
                        <td><?php echo ($plan['Plan']['retailer'] != 'Powershop') ? round($tier_rates[4]['rate'][1] * 100 * $gst, 3) : round($tier_rates[4]['rate'][1] * 100 * $gst * (1 - $plan['Plan']['discount_guaranteed_elec'] / 100), 3);?>c/per kWh</td>
                        <td><?php echo round($tier_rates[4]['rate'][1] * 100 * $gst * (1 - $total_discount_elec / 100), 3);?>c/per kWh</td>
                    </tr>
                <?php endif;?>
            </table>
        <?php else:?>
            ...
            <table>
                ...
                <?php if (count($tier_rates) == 1):?>
                    <tr>
                        <td>Charge per kWh/<?php echo $period;?></td>
                        <td><?php echo ($plan['Plan']['retailer'] != 'Powershop') ? round($tier_rates[0]['rate'] * 100 * $gst, 3) : round($tier_rates[0]['rate'] * 100 * $gst * (1 - $plan['Plan']['discount_guaranteed_elec'] / 100), 3);?>c/per kWh</td>
                        <td><?php echo round($tier_rates[0]['rate'] * 100 * $gst * (1 - $total_discount_elec / 100), 3);?>c/per kWh</td>
                    </tr>
                <?php endif;?>
                <?php if (count($tier_rates) == 2):?>
                    <tr>
                    ...
                    <tr>
                        <td>Remainder per kWh/<?php echo $period;?></td>
                        <td><?php echo ($plan['Plan']['retailer'] != 'Powershop') ? round($tier_rates[1]['rate'] * 100 * $gst, 3) : round($tier_rates[1]['rate'] * 100 * $gst * (1 - $plan['Plan']['discount_guaranteed_elec'] / 100), 3);?>c/per kWh</td>
                        <td><?php echo round($tier_rates[1]['rate'] * 100 * $gst * (1 - $total_discount_elec / 100), 3);?>c/per kWh</td>
                    </tr>
                <?php endif;?>
                <?php if (count($tier_rates) == 3):?>
                    <tr>
                    ...
                    <tr>
                        <td>Remainder per kWh/<?php echo $period;?></td>
                        <td><?php echo ($plan['Plan']['retailer'] != 'Powershop') ? round($tier_rates[2]['rate'] * 100 * $gst, 3) : round($tier_rates[2]['rate'] * 100 * $gst * (1 - $plan['Plan']['discount_guaranteed_elec'] / 100), 3);?>c/per kWh</td>
                        <td><?php echo round($tier_rates[2]['rate'] * 100 * $gst * (1 - $total_discount_elec / 100), 3);?>c/per kWh</td>
                    </tr>
                <?php endif;?>
                <?php if (count($tier_rates) == 4):?>
                    <tr>
                    ...
                    <tr>
                        <td>Remainder per kWh/<?php echo $period;?></td>
                        <td><?php echo ($plan['Plan']['retailer'] != 'Powershop') ? round($tier_rates[3]['rate'] * 100 * $gst, 3) : round($tier_rates[3]['rate'] * 100 * $gst * (1 - $plan['Plan']['discount_guaranteed_elec'] / 100), 3);?>c/per kWh</td>
                        <td><?php echo round($tier_rates[3]['rate'] * 100 * $gst * (1 - $total_discount_elec / 100), 3);?>c/per kWh</td>
                    </tr>
                <?php endif;?>
                <?php if (count($tier_rates) == 5):?>
                    <tr>
                    ...
                    <tr>
                        <td>Remainder per kWh/<?php echo $period;?></td>
                        <td><?php echo ($plan['Plan']['retailer'] != 'Powershop') ? round($tier_rates[4]['rate'] * 100 * $gst, 3) : round($tier_rates[4]['rate'] * 100 * $gst * (1 - $plan['Plan']['discount_guaranteed_elec'] / 100), 3);?>c/per kWh</td>
                        <td><?php echo round($tier_rates[4]['rate'] * 100 * $gst * (1 - $total_discount_elec / 100), 3);?>c/per kWh</td>
                    </tr>
                <?php endif;?>
            </table>
        <?php endif;?>
            ...
            <table>
                ...
                <?php if ($plan['Plan']['elec_rate']['controlled_load_1_rate_1']):?>
                    <?php if (!$plan['Plan']['elec_rate']['controlled_load_tier_1']):?>
                        <tr>
                            <td>Charge per kWh/<?php echo $period;?></td>
                            <td><?php echo ($plan['Plan']['retailer'] != 'Powershop') ? round($plan['Plan']['elec_rate']['controlled_load_1_rate_1'] * 100 * $gst, 3) : round($plan['Plan']['elec_rate']['controlled_load_1_rate_1'] * 100 * $gst * (1 - $plan['Plan']['discount_guaranteed_elec'] / 100), 3);?>c/per kWh</td>
                            <td><?php echo round($plan['Plan']['elec_rate']['controlled_load_1_rate_1'] * 100 * $gst * (1 - $total_discount_elec / 100), 3);?>c/per kWh</td>
                        </tr>
                    <?php else:?>
                        <tr>
                            <td>First <?php echo round($plan['Plan']['elec_rate']['controlled_load_tier_1'] * $ratio);?> per kWh/<?php echo $period;?></td>
                            <td><?php echo ($plan['Plan']['retailer'] != 'Powershop') ? round($plan['Plan']['elec_rate']['controlled_load_1_rate_1'] * 100 * $gst, 3) : round($plan['Plan']['elec_rate']['controlled_load_1_rate_1'] * 100 * $gst * (1 - $plan['Plan']['discount_guaranteed_elec'] / 100), 3);?>c/per kWh</td>
                            <td><?php echo round($plan['Plan']['elec_rate']['controlled_load_1_rate_1'] * 100 * $gst * (1 - $total_discount_elec / 100), 3);?>c/per kWh</td>
                        </tr>
                        <tr>
                            <td>Remainder per kWh/<?php echo $period;?></td>
                            <td><?php echo ($plan['Plan']['retailer'] != 'Powershop') ? round($plan['Plan']['elec_rate']['controlled_load_1_rate_2'] * 100 * $gst, 3) : round($plan['Plan']['elec_rate']['controlled_load_1_rate_2'] * 100 * $gst * (1 - $plan['Plan']['discount_guaranteed_elec'] / 100), 3);?>c/per kWh</td>
                            <td><?php echo round($plan['Plan']['elec_rate']['controlled_load_1_rate_2'] * 100 * $gst * (1 - $total_discount_elec / 100), 3);?>c/per kWh</td>
                        </tr>
                    <?php endif;?>
                <?php endif;?>
                <?php if ($plan['Plan']['elec_rate']['controlled_load_2_rate']):?>
                    <tr>
                        <td>Charge per kWh/<?php echo $period;?></td>
                        <td><?php echo ($plan['Plan']['retailer'] != 'Powershop') ? round($plan['Plan']['elec_rate']['controlled_load_2_rate'] * 100 * $gst, 3) : round($plan['Plan']['elec_rate']['controlled_load_2_rate'] * 100 * $gst * (1 - $plan['Plan']['discount_guaranteed_elec'] / 100), 3);?>c/per kWh</td>
                        <td><?php echo round($plan['Plan']['elec_rate']['controlled_load_2_rate'] * 100 * $gst * (1 - $total_discount_elec / 100), 3);?>c/per kWh</td>
                    </tr>
                <?php endif;?>
            </table>
        <?php endif;?>
        <?php if ($plan['Plan']['unit_of_measurement_of_rates'] && $plan['Plan']['elec_rate']['capacity_charge'] > 0):?>
            <strong>Capacity Charge</strong>
            <table>
                <tr>
                    <td>Charge per <?php echo $umo;?>/<?php echo $demandFrequency;?></td>
                    <td><?php echo round($plan['Plan']['elec_rate']['capacity_charge'] * 100 * $gst, 3);?>c/<?php echo $umo;?></td>
                    <td><?php echo round($plan['Plan']['elec_rate']['capacity_charge'] * 100 * $gst * (1 - $total_discount_elec / 100), 3);?>c/<?php echo $umo;?></td>
                </tr>
            </table>
        <?php endif;?>
        <?php if ($plan['Plan']['unit_of_measurement_of_rates'] && $plan['Plan']['elec_rate']['summer_capacity_charge'] > 0):?>
            <strong>Summer Capacity Charge</strong>
            <table>
                <tr>
                    <td>Charge per <?php echo $umo;?>/<?php echo $demandFrequency;?></td>
                    <td><?php echo round($plan['Plan']['elec_rate']['summer_capacity_charge'] * 100 * $gst, 3);?>c/<?php echo $umo;?></td>
                    <td><?php echo round($plan['Plan']['elec_rate']['summer_capacity_charge'] * 100 * $gst * (1 - $total_discount_elec / 100), 3);?>c/<?php echo $umo;?></td>
                </tr>
            </table>
        <?php endif;?>
        <?php if ($plan['Plan']['unit_of_measurement_of_rates'] && $plan['Plan']['elec_rate']['non_summer_capacity_charge'] > 0):?>
            <strong>Non Summer Capacity Charge</strong>
            <table>
                <tr>
                    <td>Charge per <?php echo $umo;?>/<?php echo $demandFrequency;?></td>
                    <td><?php echo round($plan['Plan']['elec_rate']['non_summer_capacity_charge'] * 100 * $gst, 3);?>c/<?php echo $umo;?></td>
                    <td><?php echo round($plan['Plan']['elec_rate']['non_summer_capacity_charge'] * 100 * $gst * (1 - $total_discount_elec / 100), 3);?>c/<?php echo $umo;?></td>
                </tr>
            </table>
        <?php endif;?>
        <?php if ($plan['Plan']['unit_of_measurement_of_rates'] && $plan['Plan']['elec_rate']['high_demand_charge'] > 0):?>
            <strong>High Demand Charge</strong>
            <table>
                <tr>
                    <td>Charge per <?php echo $umo;?>/<?php echo $demandFrequency;?></td>
                    <td><?php echo round($plan['Plan']['elec_rate']['high_demand_charge'] * 100 * $gst, 3);?>c/<?php echo $umo;?></td>
                    <td><?php echo round($plan['Plan']['elec_rate']['high_demand_charge'] * 100 * $gst * (1 - $total_discount_elec / 100), 3);?>c/<?php echo $umo;?></td>
                </tr>
            </table>
        <?php endif;?>
        <?php if ($plan['Plan']['unit_of_measurement_of_rates'] && $plan['Plan']['elec_rate']['low_demand_charge'] > 0):?>
            <strong>Low Demand Charge</strong>
            <table>
                <tr>
                    <td>Charge per <?php echo $umo;?>/<?php echo $demandFrequency;?></td>
                    <td><?php echo round($plan['Plan']['elec_rate']['low_demand_charge'] * 100 * $gst, 3);?>c/<?php echo $umo;?></td>
                    <td><?php echo round($plan['Plan']['elec_rate']['low_demand_charge'] * 100 * $gst * (1 - $total_discount_elec / 100), 3);?>c/<?php echo $umo;?></td>
                </tr>
            </table>
        <?php endif;?>
        <?php if ($plan['Plan']['elec_rate']['shoulder_rate']):?>
            ...
            <table>
                <tr>
                    <td>Charge per kWh/<?php echo $period;?></td>
                    <td><?php echo ($plan['Plan']['retailer'] != 'Powershop') ? round($plan['Plan']['elec_rate']['shoulder_rate'] * 100 * $gst, 3) : round($plan['Plan']['elec_rate']['shoulder_rate'] * 100 * $gst * (1 - $plan['Plan']['discount_guaranteed_elec'] / 100), 3);?>c/per kWh</td>
                    <td><?php echo round($plan['Plan']['elec_rate']['shoulder_rate'] * 100 * $gst * (1 - $total_discount_elec / 100), 3);?>c/per kWh</td>
                </tr>
            </table>
        <?php endif;?>
        <?php if ($plan['Plan']['elec_rate']['shoulder_rate']):?>
        ...
        <?php if ($plan['Plan']['elec_rate']['off_peak_rate']):?>
            ...
            <table>
                <tr>
                    <td>Charge per kWh/<?php echo $period;?></td>
                    <td><?php echo ($plan['Plan']['retailer'] != 'Powershop') ? round($plan['Plan']['elec_rate']['off_peak_rate'] * 100 * $gst, 3) : round($plan['Plan']['elec_rate']['off_peak_rate'] * 100 * $gst * (1 - $plan['Plan']['discount_guaranteed_elec'] / 100), 3);?>c/per kWh</td>
                    <td><?php echo round($plan['Plan']['elec_rate']['off_peak_rate'] * 100 * $gst * (1 - $total_discount_elec / 100), 3);?>c/per kWh</td>
                </tr>
            </table>
        <?php endif;?>
        <?php if ($plan['Plan']['elec_rate']['climate_saver_rate']):?>
            ...
            <table>
                ...
                <tr>
                    <td>Charge per kWh/<?php echo $period;?></td>
                    <td><?php echo ($plan['Plan']['retailer'] != 'Powershop') ? round($climate_saver_rate_arr[0] * 100 * $gst, 3) : round($climate_saver_rate_arr[0] * 100 * $gst * (1 - $plan['Plan']['discount_guaranteed_elec'] / 100), 3);?>c/<?php echo ($plan['Plan']['retailer'] != 'Powershop') ? round($climate_saver_rate_arr[1] * 100 * $gst, 3) : round($climate_saver_rate_arr[1] * 100 * $gst * (1 - $plan['Plan']['discount_guaranteed_elec'] / 100), 3);?>c/per kWh</td>
                    <td><?php echo round($climate_saver_rate_arr[0] * 100 * $gst * (1 - $total_discount_elec / 100), 3);?>c/<?php echo round($climate_saver_rate_arr[1] * 100 * $gst * (1 - $total_discount_elec / 100), 3);?>c/per kWh</td>
                </tr>
            </table>
        <?php endif;?>
    <?php endif;?>
...
<?php if ($rate_type == 'Gas' || $rate_type == 'Dual'):?>
    ...
    <?php else:?>
        ...
        <table>
            ...
            <tr>
                <td>Daily Supply Charge</td>
                <td><?php echo round($plan['Plan']['gas_rate']['stp'] / $stp_ratio * 100 * $gst, 3);?>c/day</td>
                <?php
                if ($plan['Plan']['discount_applies']) {
                    switch ($plan['Plan']['discount_applies']) {
                        case 'Usage':
