...
<?php if ($rate_type == 'Elec' || $rate_type == 'Dual'):?>
    ...
    <?php else:?>
        ...
        <?php if ($summer_winnter_rates):?>
            ...
            <table>
                ...
                <?php if (count($tier_rates) == 2):?>
                    ...
                    <tr>
                        <td>Remainder per kWh/per kWh</td>
        ...
        <?php if ($plan['Plan']['elec_rate']['climate_saver_rate']):?>
            ...
            <table>
                <tr>
                    <td>Summer (Peak)</td>
                    <td><?php echo round($climate_saver_rate_arr[0] * 100 * $gst * (1 - $total_discount_elec / 100), 3);?>c/per kWh</td>
                </tr>
                <tr>
                    <td>Winter (Off Peak)</td>
                    <td><?php echo round($climate_saver_rate_arr[1] * 100 * $gst * (1 - $total_discount_elec / 100), 3);?>c/per kWh</td>
                </tr>
            </table>
        <?php endif;?>
    <?php endif;?>
    <?php if ($plan['Plan']['solar_rate']):?>
        ...
        <table>
            <?php if ($step1['looking_for'] != 'Move Properties' || !in_array($state, array('NSW', 'QLD'))):?>
                <tr>
                    ...
                    <td><?php echo ($plan['Plan']['solar_rate']['government'] == '1 for 1') ? round($tier_rates[0]['rate'] * 100, 3) : $plan['Plan']['solar_rate']['government'];?>c/per kWh</td>
                </tr>
            <?php endif;?>
            <tr>
                <td>Retailer contribution per kWh</td>
                <td><?php echo ($plan['Plan']['solar_rate']['retailer'] == '1 for 1') ? round($tier_rates[0]['rate'] * 100, 3) : $plan['Plan']['solar_rate']['retailer'];?>c/per kWh</td>
            </tr>
            <tr>
        ...
        <p>$<?php echo $plan['Plan']['solar_credit'];?></p>
    <?php endif;?>
<?php endif;?>
