												...
												<?php
                                                    ...
                                                    <?php else:?>
													<strong>Peak Electricity Rates</strong>
                                                    <table>
                                                    <tr>
                                                        <td>Daily Supply Charge</td>
                                                        <?php
                                                    ...
                                                    <tr>
                                                        <td>Summer (Peak)</td>
                                                        <td><?php echo round($climate_saver_rate_arr[0] * 100 * $gst * (1 - $total_discount_elec / 100), 3);?>c</td>
                                                    </tr>
                                                    <tr>
                                                        <td>Winter (Off Peak)</td>
                                                        <td><?php echo round($climate_saver_rate_arr[1] * 100 * $gst * (1 - $total_discount_elec / 100), 3);?>c</td>
                                                    </tr>
                                                    </table>
                                                    <?php endif;?>
                                                    <?php endif;?>
