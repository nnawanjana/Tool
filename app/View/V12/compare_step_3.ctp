	    ...
	    <div class="modal-body clearfix">
	        ...
	        <div class="form-group" style="position:relative; clear:both;">
	            <a href="javascript:;" class="btn-orange pull-right close-modal">I have read this</a>
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-xs-12">
                            <p>
                            	...
                            	<?php if ($step1['renant_owner'] == 'Owner' && in_array($filters['plan_type'], array('Dual', 'Elec'))):?>Solar EOI: <?php echo ($step1['battery_storage_solar_solution'] == 'Yes' || $step1['battery_storage_solution'] == 'Yes') ? 'Yes' : 'No';?><br /><?php endif;?>
                            </p>
                        </div>
                        <div class="col-sm-6 col-xs-12">
                            <div class="plan-top">
                                <div class="plan-tool">
                                    ...
                                    <a href="/v12/">Start new comparison</a>
                    ...
                    <div class="row">
                    	<form id="filter_results_form" action="/v12/compare/3" method="post">
