...
<html lang="en">
  <head>
	...
	<?php
		...
		echo $this->Html->script('solar_sale');
...
<nav id="nav" class="hidden-phone clearfix">
	<div class="container">
    	<div class="row">
        	<div class="col-xs-12">
        	<ul>
            <li><a href="https://electricitywizard.com.au/">Home</a></li>  
...
<footer id="footer">
    ...
    <div class="row">
		<div class="copy col-xs-12">      
            <a href="https://dealexpert.com.au/" target="_blank">About Us</a> | <a onclick="window.open('https://dealexpert.com.au/privacy-policy/','windowname1','width=600, height=600, scrollbars=yes'); return false;" href="javascript: void(0)">Privacy</a> | <a href="javascript: void(0)" onclick="window.open('https://dealexpert.com.au/terms-and-conditions/','windowname1','width=600, height=600, scrollbars=yes'); return false;">Terms Of Use</a>
            </p>
			<p>Copyright &copy; <?php echo date('Y');?> Deal Expert</p>
