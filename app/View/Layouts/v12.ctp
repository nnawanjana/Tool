...
<html lang="en">
  <head>
	...
	<?php
		...
		echo $this->Html->script('scripts_v12');
...
<header id="header" class="clearfix">
	<div class="container">
    	<div class="row">
        	<div class="col-sm-6">
            	<div id="logo">
                	<a href="https://dealexpert.com.au/"><?php echo $this->Html->image('SD_logo.png', array('alt' => 'Home','class'=>'img-responsive'));?></a>
                </div>
            </div>    
            <div class="col-sm-6">
            </div>
