...
<header id="header" class="clearfix">
	<div class="container">
    	<div class="row">
        	<div class="col-sm-6">
            	<div id="logo">
                	<a href="https://electricitywizard.com.au/"><?php echo $this->Html->image('logo.png', array('alt' => 'Home','class'=>'img-responsive'));?></a>
                </div>
            </div>    
            <div class="col-sm-6">
            	<div id="tagline">
                	<div id="tel"><span class=""><a href="tel:1300087011">1300 087 011</a></span></div>
                  <div id="open-hours">Mon-Fri: 8am-8pm | Sat-Sun: 9am-5pm</div>
                </div>
            </div>
        </div>
    </div>    
