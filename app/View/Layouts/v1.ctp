...
<html lang="en">
  <head>
	...
	<?php
		...
		echo $this->Html->script('scripts_v1');
		
		echo $this->Html->script('jquery.topbar');
		echo $this->Html->css('topbar');
...
<body>
<?php if ($step == 3 && !$conversion_tracked):?>
<div class="topbar topbar-primary" id="mynotification">
	<div class="container">Success, you can now start comparing energy plans! We'll call you shortly to discuss your options!
...
<header id="header" class="clearfix">
	<div class="container">
    	<div class="row">
        	<div class="col-sm-4">
            	<div id="logo">
                	<a href="http://dealexpert.com.au/"><?php echo $this->Html->image('logo.png', array('alt' => 'Home','class'=>'img-responsive'));?></a>
                </div>
            </div>    
            <div class="col-sm-8">
            	<div class="row">
        		<div class="col-sm-7"><div id="headline">
                	<span style="color: rgb(102, 102, 102); font-size: 21px;">Need Some Help Comparing</span> 
                    <span style="color: rgb(153, 153, 153); font-size: 18px;">No problem! Give us a call on...</span>
                </div></div>
            	<div class="col-sm-5"><div id="tagline">
                	<div id="tel"><span class=""><a href="tel:1300087011">1300 087 011</a></span></div>
                    <div id="open-hours"><strong>Mon-Fri</strong>: 8am-8pm | <strong>Sat-Sun</strong>: 9am-5pm</div>
                </div></div>
                </div>
            </div>
        </div>
...
<nav id="nav" class="hidden-phone clearfix">
	<div class="container">
    	<div class="row">
        	<div class="col-xs-12">
        	<ul>
            <li><a href="http://dealexpert.com.au/">Home</a></li>  
            ...
            <li <?php if ($step == 2):?>class="active"<?php endif;?>><?php if ($step2):?><a href="/<?php echo $this->params['controller'];?>/compare/2"><?php endif;?>Product Options<? if ($step2):?></a><?php endif;?></li> 
