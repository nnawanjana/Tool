...
<div class="modal fade" id="gst_disclaimer_modal" tabindex="-1" role="dialog" aria-labelledby="gst_disclaimer_modalLabel" aria-hidden="true">
	<div class="modal-dialog">
	  <div class="modal-content">
	    <div class="modal-body clearfix">
	        <h2>Disclaimer</h2>
			<p>I'll provide you exclusive GST charges today. Just so you know, the rates you are charged will be GST inclusive. Please advise if you would like me to provide you with inclusive GST charges</p>
	        <div class="col-sm-12 clearfix">
	        <div class="form-group" style="position:relative; clear:both;">
                                ...
                                ?>
                                    <div id="plan-<?php echo $plan['Plan']['id'];?>" class="plan">
                                        <div class="plan-visible">
                                            ...
                                            <div class="plan-label">Discounts: <?php if ($plan['Plan']['product_summary']):?><span class="info" title="<b>Please read this text verbatim whilst pitching this product:</b><br><br><?php echo $plan['Plan']['product_summary'];?>" style="float:right;"><img src="/img/psummary.png"></span><?php endif;?></div>
                                            ...
                                            <div style="float:left;"><?php if ($has_bonus_sumo_discount && $plan['Plan']['retailer'] == 'Sumo Power'):?><span class="info" title="Bonus Pay on Time discount is not applied. Click to apply Bonus Pay on Time discount"><a href="#" class="btn-bon"></a></span> <?php endif;?><?php if ($has_prepay_discount && $plan['Plan']['retailer'] == 'Sumo Power'):?><span class="info" title="Prepay discount is not applied. Click to apply Prepay discount"><a href="#" class="btn-pre"></a></span> <?php endif;?><?php if ($has_guaranteed_discount && $plan['Plan']['retailer'] != 'Powershop'):?><span class="info" title="Guaranteed discount is not applied. Click to apply Guaranteed discount"><a href="#" class="btn-gtd"></a></span> <?php endif;?><?php if ($has_pay_on_time_discount):?><span class="info" title="Pay On Time discount is not applied. Click to apply Pay On Time discount"><a href="#" class="btn-pot"></a></span> <?php endif;?><?php if ($has_direct_debit_discount):?><span class="info" title="Direct Debit discount is not applied. Click to apply Direct Debit discount"><a href="#" class="btn-dd"></a></span><?php endif;?><?php if ($has_dual_fuel_discount):?><span class="info" title="Double up discount is not applied. Click to apply Double up discount"><a href="#" class="btn-dud"></a></span><?php endif;?></div>
                                            <div style="float:right;"><span class="info" title="GST is currently applied. Click to exclude GST"><a href="#" class="btn-gst2 active"></a></span></div>
                                            <div class="clearfix"></div>
                                            </form>
                                            <div class="table-rate" id="table1_rate_<?php echo $plan['Plan']['id'];?>">
                                            <?php echo $this->element('rates_v4', array('plan' => $plan, 'discount_pay_on_time' => false, 'discount_guaranteed' => false, 'discount_direct_debit' => false, 'discount_bonus_sumo' => false, 'include_gst' => true, 'rate_type' => $filters['plan_type'])); ?>
                                            </div>
                                            </div>
                                            ...
                                            <div class="call">to <span class="signup" onclick="signup(<?php echo $plan['Plan']['id'];?>, <?php echo (isset($plan['Plan']['elec_rate'])) ?$plan['Plan']['elec_rate']['id'] : 0;?>, <?php echo (isset($plan['Plan']['gas_rate'])) ?$plan['Plan']['gas_rate']['id'] : 0;?>);">sign up</span><br />Call <?php echo $this->Html->image('tel2.png', array('alt' => ''));?> <span class="AVANSERnumber"><a href="tel:1300359779">1300 359 779</a></span></div>
