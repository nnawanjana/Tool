...
<div id="step3" class="step clearfix">
    ...
    <div class="row">
        <div class="col-sm-6 col-xs-12 pull-right">
            <div class="form-group">
                <div class="col-sm-3">
                    <a href="javascript:;" class="btn-orange pull-left solar-interest-button">Solar Interest</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <form id="filter_results_form" action="/v5/compare/3" method="post">
                        ...
                        <div class="filter-scroll">
                            ...
                            <div class="form-item">
                                ...
                                <div class="form-element" <?php if (!empty($filters['retailer'])):?>style="display:block;"<?php endif;?>>
                                    ...
                                    <?php endif;?>
                                    <?php if (in_array('OVO Energy', $available_retailers)):?>
                                        <label><input type="checkbox" name="retailer[]" class="retailer" value="OVO Energy" <?php if (in_array('OVO Energy', $filters['retailer'])):?>checked="checked"<?php endif;?>>OVO Energy</label>
                                    <?php endif;?>
                                </div>
                            </div>
                    ...
                    <?php foreach ($plans as $plan):?>
                        ...
                        <div id="plan-<?php echo $plan['Plan']['id'];?>" class="plan">
                            <div class="plan-visible">
                                ...
                                <div class="plan-label"><strong>Read Verbatim</strong></div>
