		...
		<form id="customer_details_form" onsubmit="return false;">
				...
				<div id="customer_details" class="step clearfix">
				    <div class="form-horizontal">
    				    <div class="form-section col-sm-12 clearfix">
        				    <div style="padding:10px;">
                                ...
                                <h4 align="center" style="color:red;">This call is being recorded for training and quality. We compare a number of retailers and plans on our panel to find you the most suitable. Our service is free, if you accept an offer, Deal Expert will receive a fee directly from the retailer</h4>
        				    </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <a href="/v5/compare/1" class="btn-orange pull-left comparison-continue">Continue</a>
                            <a href="/v5/" class="pull-left">or start a new comparison</a>
                        </div>
                    </div> 
                    </div>
