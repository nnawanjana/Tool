	...
	<div class="modal fade" id="qld_modal" tabindex="-1" role="dialog" aria-labelledby="qld_modalLabel" aria-hidden="true">
	  <div class="modal-dialog">
	    <div class="modal-content">
	      <div class="modal-body clearfix">
	      		<form id="step1_qld_form" class="step" onsubmit="return false;">
	      			<div class="form-horizontal">
	                    <div class="form-section col-sm-12 clearfix ">
                        <div class="form-group">
	                        <h2>IMPORTANT</h2>
                        	<p style="margin:30px;">Please ensure you use the QLD Alinta Solar Calculator for this comparison as you are completing a solar, bill to bill comparison in Queensland</p>
                        </div>
	                    </div>
	                    <div class="col-sm-12 clearfix">
	                    <div class="form-group" style="position:relative; clear:both;">
			...
			<input type="hidden" value="<?php echo ($inbound) ? 1 : 0;?>" name="inbound" id="inbound">
				...
				<div id="step1" class="step clearfix">
                    ...
                    <div class="start-new-comparison">
                        <a class="test-lead" href="javascript:;">Test Lead</a>
                    	<a href="/v5/">Start new comparison</a>
                    </div>
                    <div class="form-horizontal">

                    <div class="form-section col-sm-12 clearfix">
                    <div class="form-group">
                        <label class="control-label col-sm-4 col-sm-offset-1"><span class="info" title="Lead ID (if applicable)"><?php echo $this->Html->image('img-question.png', array('alt' => ''));?></span>Lead ID (if applicable)</label>
                        <div class="col-sm-3">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <input class="form-control" type="text" name="agent_name" value="" id="agent_name" placeholder="User" disabled="disabled">
                    ...
                    <div class="form-group">
                        <label class="control-label col-sm-4 col-sm-offset-1"><span class="info" title="Customer's Email"><?php echo $this->Html->image('img-question.png', array('alt' => ''));?></span>Email</label>
                        <div class="col-sm-3">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            ...
                            <input type="hidden" name="is_broadband" value="<?php echo (!empty($step1) && $step1['is_broadband']) ? 1 : 0;?>" id="is_broadband">
                            ...
                            <div id="Broadband" class="is-broadband"></div>
                        </div>
                    ...
                    <div class="form-section col-sm-12 clearfix">
                        <div id="elec_transfer" style="display:none;">
    						<div class="form-group">
                                <label class="control-label col-sm-4 col-sm-offset-1"><span class="info"><img src="/img/img-question.png" alt=""></span>Do you know your current electricity discount?</label>
                                <div class="col-sm-5">
                            ...
                            <div class="form-group elec-current-discount-yes" style="display:none;">
                                <label class="control-label col-sm-4 col-sm-offset-1"><span class="info" title=""><?php echo $this->Html->image('img-question.png', array('alt' => ''));?></span>Discount %</label>
                                <div class="col-sm-2">
                            ...
                            <div class="form-group elec-current-discount-yes" style="display:none;">
                                <label class="control-label col-sm-4 col-sm-offset-1"><span class="info" title=""><?php echo $this->Html->image('img-question.png', array('alt' => ''));?></span>Discount Type</label>
                                <div class="col-sm-5">
                            ...
                            <div class="form-group elec-current-discount-yes" style="display:none;">
                                <label class="control-label col-sm-4 col-sm-offset-1"><span class="info" title=""><?php echo $this->Html->image('img-question.png', array('alt' => ''));?></span>Discount Applies</label>
                                <div class="col-sm-5">
                        ...
                        <div id="gas_transfer" style="display:none;">
    						<div class="form-group">
                                <label class="control-label col-sm-4 col-sm-offset-1"><span class="info"><img src="/img/img-question.png" alt=""></span>Do you know your current gas discount?</label>
                                <div class="col-sm-5">
                    ...
                    <div class="form-group">
                        <label class="control-label col-sm-4 col-sm-offset-1"><span class="info"><?php echo $this->Html->image('img-question.png', array('alt' => ''));?></span>How much is an average electricity bill for you household?</label>
                    ...
                    <div class="form-group">
                        ...
                        <div id="solar_fields" style="display:none;">
                            ...
                            <div class="form-group">
                                <label class="control-label col-sm-4 col-sm-offset-1"><span class="info" title="Is your inverter capacity less than 10kW?"><?php echo $this->Html->image('img-question.png', array('alt' => ''));?></span>Is your inverter capacity less than 10kW?</label>
                                <div class="col-sm-5">
                        ...
                        <div class="form-group" id="elec_meter_type_fields">
                            <label class="control-label col-sm-4 col-sm-offset-1">Please enter your usage</label>
                            <div class="col-sm-7">
                                ...
                                <div class="radio" id="timeofuse_cs_radio">
                                    ...
                                    <div class="row radio-hidden margin-top">
                                        <div class="col-sm-4 col-xs-12"><span class="des peak-des">Peak</span><input type="text" class="form-control" name="timeofuse_cs_peak" id="timeofuse_cs_peak" value="<?php echo (!empty($step1) && isset($step1['timeofuse_cs_peak'])) ? $step1['timeofuse_cs_peak'] : '';?>"></div>
                                ...
                                <div class="radio" id="timeofuse_cl1_cs_radio">
                                    ...
                                    <div class="row radio-hidden">
                                        <div class="col-sm-4 col-xs-12"><span class="des peak-des">Peak</span><input type="text" class="form-control" name="timeofuse_cl1_cs_peak" id="timeofuse_cl1_cs_peak" value="<?php echo (!empty($step1) && isset($step1['timeofuse_cl1_cs_peak'])) ? $step1['timeofuse_cl1_cs_peak'] : '';?>"></div>
                                        <div class="col-sm-4 col-xs-12"><span class="des">Off-Peak</span><input type="text" class="form-control" name="timeofuse_cl1_cs_offpeak" id="timeofuse_cl1_cs_offpeak" value="<?php echo (!empty($step1) && isset($step1['timeofuse_cl1_cs_offpeak'])) ? $step1['timeofuse_cl1_cs_offpeak'] : '';?>"></div>
                                        <div class="col-sm-4 col-xs-12"><span class="des">Controlled Load 1</span><input type="text" class="form-control" name="timeofuse_cl1" id="timeofuse_cl1" value="<?php echo (!empty($step1) && isset($step1['timeofuse_cl1'])) ? $step1['timeofuse_cl1'] : '';?>"></div>
                                        <div class="col-sm-4 col-xs-12"><span class="des">Climate Saver</span><input type="text" class="form-control" name="timeofuse_2_cs" id="timeofuse_2_cs" value="<?php echo (!empty($step1) && isset($step1['timeofuse_2_cs'])) ? $step1['timeofuse_2_cs'] : '';?>"></div>
                                        <div class="col-sm-4 col-xs-12"><span class="des">Billing Start</span><input type="text" class="form-control" placeholder="" name="timeofuse_cl1_cs_billing_start" id="timeofuse_cl1_cs_billing_start" value="<?php echo (!empty($step1)) ? $step1['timeofuse_cl1_cs_billing_start'] : '';?>"></div>
                                    </div>
                                </div>
                                <div class="radio" id="timeofuse_cl1_radio">
                                    ...
                                    <div class="row radio-hidden">
                                        <div class="col-sm-4 col-xs-12"><span class="des peak-des">Peak</span><input type="text" class="form-control" name="timeofuse_cl1_peak" id="timeofuse_cl1_peak" value="<?php echo (!empty($step1) && isset($step1['timeofuse_cl1_peak'])) ? $step1['timeofuse_cl1_peak'] : '';?>"></div>
                                        <div class="col-sm-4 col-xs-12"><span class="des">Off-Peak</span><input type="text" class="form-control" name="timeofuse_cl1_offpeak" id="timeofuse_cl1_offpeak" value="<?php echo (!empty($step1) && isset($step1['timeofuse_cl1_offpeak'])) ? $step1['timeofuse_cl1_offpeak'] : '';?>"></div>
                                        <div class="col-sm-4 col-xs-12"><span class="des">Controlled Load 1</span><input type="text" class="form-control" name="timeofuse_2_cl1" id="timeofuse_2_cl1" value="<?php echo (!empty($step1) && isset($step1['timeofuse_2_cl1'])) ? $step1['timeofuse_2_cl1'] : '';?>"></div>
                                        <div class="col-sm-4 col-xs-12" id="timeofuse_cl1_shoulder_field"><span class="des">Shoulder</span><input type="text" class="form-control" name="timeofuse_cl1_shoulder" id="timeofuse_cl1_shoulder" value="<?php echo (!empty($step1) && isset($step1['timeofuse_cl1_shoulder'])) ? $step1['timeofuse_cl1_shoulder'] : '';?>"></div>
                                    </div>
                                </div>
                                <div class="radio" id="timeofuse_cl2_radio">
                                    ...
                                    <div class="row radio-hidden">
                                        <div class="col-sm-4 col-xs-12"><span class="des peak-des">Peak</span><input type="text" class="form-control" name="timeofuse_cl2_peak" id="timeofuse_cl2_peak" value="<?php echo (!empty($step1) && isset($step1['timeofuse_cl2_peak'])) ? $step1['timeofuse_cl2_peak'] : '';?>"></div>
                                        <div class="col-sm-4 col-xs-12"><span class="des">Off-Peak</span><input type="text" class="form-control" name="timeofuse_cl2_offpeak" id="timeofuse_cl2_offpeak" value="<?php echo (!empty($step1) && isset($step1['timeofuse_cl2_offpeak'])) ? $step1['timeofuse_cl2_offpeak'] : '';?>"></div>
                                        <div class="col-sm-4 col-xs-12"><span class="des">Controlled Load 2</span><input type="text" class="form-control" name="timeofuse_2_cl2" id="timeofuse_2_cl2" value="<?php echo (!empty($step1) && isset($step1['timeofuse_2_cl2'])) ? $step1['timeofuse_2_cl2'] : '';?>"></div>
                                        <div class="col-sm-4 col-xs-12" id="timeofuse_cl2_shoulder_field"><span class="des">Shoulder</span><input type="text" class="form-control" name="timeofuse_cl2_shoulder" id="timeofuse_cl2_shoulder" value="<?php echo (!empty($step1) && isset($step1['timeofuse_cl2_shoulder'])) ? $step1['timeofuse_cl2_shoulder'] : '';?>"></div>
                                    </div>
                                </div>
                    ...
                    <div class="form-section col-sm-12 clearfix g-y g-n hidden-field">
						...
						<div class="form-group">
                        <label class="control-label col-sm-4 col-sm-offset-1"><span class="info"><?php echo $this->Html->image('img-question.png', array('alt' => ''));?></span>How much is an average gas bill for you household?</label>
                    ...
                    <div class="form-group">
                        <label class="control-label col-sm-4 col-sm-offset-1"><span class="info" title="Company Industry"><?php echo $this->Html->image('img-question.png', array('alt' => ''));?></span>Company Industry</label>
                        <div class="col-sm-5">
                    ...
                    <div class="form-section col-sm-12 clearfix">
                    <div class="form-group">
                        <label class="control-label col-sm-4 col-sm-offset-1"><span class="info" title="Are you the Tenant or the Owner?"><?php echo $this->Html->image('img-question.png', array('alt' => ''));?></span>Are you the Tenant or the Owner?</label>
                        <div class="col-sm-5">
                    ...
                    <div class="form-group battery-storage-solution" style="display:none;">
                        <label class="control-label col-sm-4 col-sm-offset-1"><span class="info" title="Are you interested to know more about our battery storage solution?"><?php echo $this->Html->image('img-question.png', array('alt' => ''));?></span>Are you interested to know more about our battery storage solution?</label>
                        <div class="col-sm-5">
                    ...
                    <div class="form-group battery-storage-solar-solution" style="display:none;">
                        <label class="control-label col-sm-6 col-sm-offset-1"><span class="info" title="Are you interested to know more about our battery storage & solar solution?"><?php echo $this->Html->image('img-question.png', array('alt' => ''));?></span>Are you interested to know more about our battery storage & solar solution?</label>
                        <div class="col-sm-5">
                    ...
                    <div class="form-group">
                        <div class="text-right" id="term1_field">
                            ...
                            I have read, understood and accept the <a href="https://dealexpert.com.au/terms-and-conditions/" target="_blank">Terms and Conditions</a> & <a href="https://dealexpert.com.au/terms-and-conditions/" target="_blank">Terms and Conditions</a>.
                        </div>
                    </div>
                    </div>
