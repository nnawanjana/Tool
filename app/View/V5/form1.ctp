...
<?php echo $this->Form->create('Form1', array('id' => 'ToolsLeadForm1')); ?>
	...
	<?php
	    ...
	    echo $this->Form->input('tenant_owner', array('label' => 'Owner / Renter', 'id' => 'tenant_owner', 'name' => 'tenant_owner', 'options' => $owner_renter, 'required' => true, 'div' => 'form-group', 'class' => 'form-control'));
