	    ...
	    <div class="modal-body clearfix">
	        ...
	        <div class="form-group" style="position:relative; clear:both;">
	            <a href="javascript:;" class="btn-orange pull-right close-modal">I have read this</a>
                        ...
                        <div class="col-sm-6 col-xs-12">
                            <div class="plan-top">
                                <div class="plan-tool">
                                    ...
                                    <a href="/v11/">Start new comparison</a>
                    ...
                    <div class="row">
                    	<form id="filter_results_form" action="/v11/compare/3" method="post">
