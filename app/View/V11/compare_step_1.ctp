			...
			<input type="hidden" value="<?php echo ($inbound) ? 1 : 0;?>" name="inbound" id="inbound">
				...
				<div id="step1" class="step clearfix">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <select class="form-control" name="renant_owner" id="renant_owner">
                                <option value="">Select</option>
                                <option value="Renter" <?php if (!empty($step1) && $step1['renant_owner'] == 'Renter'):?>selected="selected"<?php endif;?>>Tenant</option>
                                <option value="Owner" <?php if (!empty($step1) && $step1['renant_owner'] == 'Owner'):?>selected="selected"<?php endif;?>>Owner</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="text-right" id="term1_field">
                            ...
                            I have read, understood and accept the <a href="http://www.seekdeals.com.au/terms-conditions/" target="_blank">Terms and Conditions</a> & <a href="http://www.seekdeals.com.au/privacy-policy/" target="_blank">Privacy Policy</a>.
                        </div>
                    </div>
                    </div>
