...
<div class="modal fade" id="electricity_modal" tabindex="-1" role="dialog" aria-labelledby="electricity_modalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-body v4_form v2 clearfix">
                    ...
                    <div class="form-horizontal">
                        ...
                        <div class="col-sm-12 clearfix">
                            <div class="form-group" style="position:relative; clear:both;">
                                <a href="javascript:;" class="btn-orange v2 pull-right continue">Get My Estimated Cost</a>
...
<div class="v4_form v3 v4">
	<div class="row">
		<div class="col-md-1">
			...
			<li class="active"><a href="/<?php echo $this->params['controller'];?>/compare/1"><?php echo $this->Html->image('v4/step1.png', array('alt' => ''));?></a></li>	
            <li <?php if ($step == 2):?>class="active"<?php endif;?>><?php if ($step2):?><a href="/<?php echo $this->params['controller'];?>/compare/2"><?php endif;?><?php echo $this->Html->image('v4/step2.png', array('alt' => ''));?><?php if ($step2):?></a><?php endif;?></li> 
            <li <?php if ($step == 3):?>class="active"<?php endif;?>><?php if ($step1 && $step2):?><a href="/<?php echo $this->params['controller'];?>/compare/3"><?php endif;?><?php echo $this->Html->image('v4/step3.png', array('alt' => ''));?><?php if ($step1 && $step2):?></a><?php endif;?></li>
            <li <?php if ($step == 4):?>class="active"<?php endif;?>><a href="/<?php echo $this->params['controller'];?>/form1"><?php echo $this->Html->image('v4/step4.png', array('alt' => ''));?></a></li>
            </ul>
		</div>
		<div class="col-md-11">	
<div id="step3" class="step clearfix"><div class="form-section v2">
	...
	<h2 class=" mb2">Your <?php echo $plan_type;?> Search Results</h2>
    <div class="row">
		...
		<div class="col-sm-6 col-xs-12 text-right">
			<a class="plan-top-pocks" href="/<?php echo $this->params['controller'];?>/compare/3?view_top_picks=1#step3">View my top picks <span id="top_picks_count">(0)</span> <?php echo $this->Html->image('v4/star.png', array('alt' => ''));?></a><a id="clear_my_top_picks" class="plan-clear" href="javascript:;">Clear</a>
		</div>
		...
		<p>
                ...
                <?php if ($tariffs):?>Solar Tariff: <?php echo ($solar_specific_plan) ? 'Yes' : 'No';?><br /><?php endif;?>
                <?php if ($step1['tenant_owner'] == 'Owner' && in_array($filters['plan_type'], array('Dual', 'Elec'))):?>Solar EOI: <?php echo ($step1['battery_storage_solar_solution'] == 'Yes' || $step1['battery_storage_solution'] == 'Yes') ? 'Yes' : 'No';?><br /><?php endif;?>
                <?php if ($step1['lead_origin']):?>Lead Generation Type: <?php echo $step1['lead_origin'];?><br /><?php endif;?>
            </p>
		</div>
		<div class="col-sm-6 col-xs-12 text-right">
			<div class="start-new-comparison"><a href="/v4/">New comparison</a></div>
		</div>	
    </div>
    <div class="row">
        <div class="col-sm-12"><div class="form-group v4_field d-flex justify-content-between align-items-center">
			...
			<a href="javascript:;" class="btn-orange solar-interest-button">Solar Interest</a>
		
			<a href="javascript:;" class="btn-grey no-sale-button">No Sale</a>
		
			<a class="pause-save btn-orange" href="javascript:;"><?php echo $this->Html->image('v4/save.png', array('alt' => ''));?> Pause & Save</a>
        </div></div>
    </div>

    <?php $total = count($plans);?>
    <div class="row"><div class="col-sm-12">
        <form id="filter_results_form" action="/v4/compare/3" method="post">
            ...
            <?php /*?><div class="form-group">
				...
				<div class="plan-pagination-wrap">
					<div class="total">Results <?php echo $total;?></div>
					<?php if ($total > 0):?>
            ...
            <?php /*?><div class="plans-search">
                <?php if (!$view_top_picks):?>
                    <div class="plans-search-title">Filter<a href="javascript:;" class="clear-filters">Reset</a></div>
                    <div class="plans-search-filters">
                        ...
                        <div class="filter-scroll">
                            ...
                            -->
                            <div class="form-item"><a href="javascript:;" class="clear-filters">Reset</a></div>
                        </div>
                    </div>
                <?php else:?>
			...
			<div class="form-group">
				<div class="sortby-wrapper">
					<a href="#"><?php echo $this->Html->image('v4/btn-sortby.png', array('alt' => ''));?></a>
				</div>
				<div class="fliter-wrapper">
					<a href="#"><?php echo $this->Html->image('v4/btn-filters.png', array('alt' => ''));?></a>
				</div>
			</div>
        </form>
                        ...
                        <div id="plan-<?php echo $plan['Plan']['id'];?>" class="plan">
                            <div class="plan-visible">
                                <div class="plan-favor">
                                    <a class="add-to-top-picks" rel="<?php echo $plan['Plan']['id'];?>" href="javascript:;"><?php if ($top_picks && in_array($plan['Plan']['id'], $top_picks)):?><?php echo $this->Html->image('v4/stary.png', array('alt' => ''));?><?php else:?><?php echo $this->Html->image('v4/starg.png', array('alt' => ''));?><?php endif;?></a>
								...
								<div class="row">
								<div class="col-md-6">
                                <div class="plan-label">Read Verbatim</div>
                                <h4><?php if (isset($plan['Plan']['elec_dmo_vdo']) && $plan['Plan']['elec_dmo_vdo']):?>
                                        <?php if ($plan['Plan']['retailer'] == 'Momentum'):?>
                                            <?php if ($plan['Plan']['res_sme'] == 'RES'):?>
                                                <?php if (in_array($step1['elec_meter_type'], array('Single Rate', 'Time of Use')) || in_array($step1['elec_meter_type2'], array('Single Rate', 'Time of Use'))):?>
                                                    There's some information I need to give you about this plan, so you have a clearer idea of what it may mean for you.<br>
                                                    You're in the <?php echo $plan['Plan']['elec_dmo_vdo']['distributor'];?> distribution zone and you’re a residential customer without a controlled load tariff. So if you used <?php echo $plan['Plan']['elec_dmo_vdo']['default_offer_kwh'];?>kWh of electricity a year on these rates, you would be paying about $<?php echo $plan['Plan']['elec_dmo_vdo']['default_retailer_cost'];?> a year. This is <?php echo $plan['Plan']['elec_dmo_vdo']['default_offer_difference_percent'];?>% <?php echo $plan['Plan']['elec_dmo_vdo']['default_offer_difference_percent_type'];?> the reference price set by the regulator. And of course, this estimate will vary if you use more or less electricity, if our rates change or if you move to a different tariff type.
                                                <?php elseif (in_array($step1['elec_meter_type'], array('Single Rate + CL1', 'Single Rate + CL2', 'Single Rate + CL1 + CL2', 'Time of Use + CL1', 'Time of Use + CL2')) || in_array($step1['elec_meter_type2'], array('Single Rate + CL1', 'Single Rate + CL2', 'Single Rate + CL1 + CL2', 'Time of Use + CL1', 'Time of Use + CL2'))):?>
                                                    There's some information I need to give you about this plan, so you have a clearer idea of what it may mean for you.<br>
                                                    You're in the <?php echo $plan['Plan']['elec_dmo_vdo']['distributor'];?> distribution zone and you’re a residential customer with a controlled load tariff. So if you used <?php echo $plan['Plan']['elec_dmo_vdo']['default_offer_kwh'];?>kWh of electricity a year on these rates, you would be paying about $<?php echo $plan['Plan']['elec_dmo_vdo']['default_retailer_cost'];?> a year. This is <?php echo $plan['Plan']['elec_dmo_vdo']['default_offer_difference_percent'];?>% <?php echo $plan['Plan']['elec_dmo_vdo']['default_offer_difference_percent_type'];?> the reference price set by the regulator. And of course, this estimate will vary if you use more or less electricity, if our rates change or if you move to a different tariff type.
                                                <?php endif;?>
                                            <?php elseif ($plan['Plan']['res_sme'] == 'SME'):?>
                                                There's some information I need to give you about this plan, so you have a clearer idea of what it may mean for you.<br>
                                                You're in the <?php echo $plan['Plan']['elec_dmo_vdo']['distributor'];?> distribution zone and you’re a small business customer. So if you used <?php echo $plan['Plan']['elec_dmo_vdo']['default_offer_kwh'];?>kWh of electricity a year on these rates, you would be paying about $<?php echo $plan['Plan']['elec_dmo_vdo']['default_retailer_cost'];?> a year. This is <?php echo $plan['Plan']['elec_dmo_vdo']['default_offer_difference_percent'];?>% <?php echo $plan['Plan']['elec_dmo_vdo']['default_offer_difference_percent_type'];?> the reference price set by the regulator. And of course, this estimate will vary if you use more or less electricity, if our rates change or if you move to a different tariff type.
                                            <?php endif;?>
                                        <?php elseif ($plan['Plan']['retailer'] == 'Origin Energy'):?>
                                            <?php if ($plan['Plan']['elec_dmo_vdo']['dmo']):?>
                                                <?php echo $plan['Plan']['elec_dmo_vdo']['dmo'];?>
                                            <?php endif;?>
                                        <?php elseif ($plan['Plan']['retailer'] == 'Sumo Power' && ($state == 'VIC' || $state == 'NSW')):?>
                                            <?php if ($plan['Plan']['elec_dmo_vdo']['dmo']):?>
                                                <?php echo $plan['Plan']['elec_dmo_vdo']['dmo'];?>
                                            <?php endif;?>
                                        <?php elseif ($plan['Plan']['retailer'] == 'Lumo Energy'):?>
                                            <?php if ($plan['Plan']['elec_dmo_vdo']['dmo']):?>
                                                <?php echo $plan['Plan']['elec_dmo_vdo']['dmo'];?>
                                            <?php endif;?>
                                        <?php elseif ($plan['Plan']['retailer'] == 'Next Business Energy'):?>
                                            <?php if ($plan['Plan']['elec_dmo_vdo']['dmo']):?>
                                                <?php echo $plan['Plan']['elec_dmo_vdo']['dmo'];?>
                                            <?php endif;?>
                                        <?php elseif ($plan['Plan']['retailer'] == 'Alinta Energy'):?>
                                            <?php if ($plan['Plan']['elec_dmo_vdo']['dmo']):?>
                                                <?php echo $plan['Plan']['elec_dmo_vdo']['dmo'];?>
                                            <?php endif;?>
                                        <?php elseif ($plan['Plan']['retailer'] == 'Powershop'):?>
                                            <?php if ($plan['Plan']['elec_dmo_vdo']['dmo']):?>
                                                <?php echo $plan['Plan']['elec_dmo_vdo']['dmo'];?>
                                            <?php endif;?>
                                        <?php elseif ($plan['Plan']['retailer'] == 'AGL'):?>
                                            <?php if ($plan['Plan']['elec_dmo_vdo']['dmo']):?>
                                                <?php echo $plan['Plan']['elec_dmo_vdo']['dmo'];?>
                                            <?php endif;?>
                                        <?php elseif ($plan['Plan']['retailer'] == 'Powerdirect'):?>
                                            <?php if ($plan['Plan']['elec_dmo_vdo']['dmo']):?>
                                                <?php echo $plan['Plan']['elec_dmo_vdo']['dmo'];?>
                                            <?php endif;?>
                                        <?php else:?>
                                            I need to let you know about some important information for this plan. <br>
                                            Based on the information you provided, we’ve determined you’re in the <?php echo $plan['Plan']['elec_dmo_vdo']['distributor'];?> network. You’re a <?php echo $plan['Plan']['res_sme'] == 'RES' ? 'Residential' : 'Business';?> customer on a <?php echo $plan['Plan']['elec_dmo_vdo']['tariff_type'];?> tariff and if you used <?php echo $plan['Plan']['elec_dmo_vdo']['default_offer_kwh'];?> kilowatt hour per year, the <?php echo $plan['Plan']['product_name'];?> would be an estimated annual cost of $<?php echo $plan['Plan']['elec_dmo_vdo']['default_retailer_cost'];?>. This is <?php echo $plan['Plan']['elec_dmo_vdo']['default_offer_difference_percent'];?>% <?php echo $plan['Plan']['elec_dmo_vdo']['default_offer_difference_percent_type'];?> the reference price set by the regulator. <br>
                                            These figures are based on an average customer in your distribution zone with your tariff type and the estimate will vary if you use more or less electricity.
                                        <?php endif;?>
                                    <?php else:?>
                                        VDO Script Not Applicable
                                    <?php endif;?></h4>
								</div>
								<div class="col-md-6">
                                <div class="plan-label">Estimated Cost</div>
                                <div class="estimated-cost">
                                    <?php if (isset($step1['solar_generated']) && $step1['solar_generated']):?>
                                        <p style="font-weight: bold; color: red;">THIS ESTIMATED TOTAL INCLUDES SOLAR CONTRIBUTION</p>
                                    <?php endif;?>
                                    <?php if ($step1['elec_recent_bill'] == 'Yes' || $step1['gas_recent_bill'] == 'Yes'):?>
                                        <p style="font-weight: bold;">Based on the information you have provided, the estimated cost including GST would be:<br />
                                    ...
                                    <?php endif;?>
                                    <?php if ($step1['elec_recent_bill'] == 'No'):?><div class="estimated-cost-type-wrapper">
                                        <div class="estimated-cost-type">Electricity<span class="info" title="We just need your bill details to display a cost estimate"><img src="/img/v4/question.png"></span></div>
                                        <a href="javascript:;" class="enter-elec-details">Enter my bill details</a></div>
                                    <?php endif;?>
                                    <?php if ($step1['gas_recent_bill'] == 'No'):?><div class="estimated-cost-type-wrapper">
                                        <div class="estimated-cost-type">Gas<span class="info" title="We just need your bill details to display a cost estimate"><img src="/img/v4/question.png"></span></div>
                                        <a href="javascript:;" class="enter-gas-details">Enter my bill details</a></div>
                                    <?php endif;?>
    ...
    <div class="row">
        <div class="col-sm-12 col-xs-12">
            <a href="/<?php echo $this->params['controller'];?>/compare/2" class="btn-grey pull-left">Back</a>
            <?php /*?><div class="plan-pagination-wrap">
